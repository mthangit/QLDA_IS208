...
<body>
    ...
    <section id="content">
        ...
        <div class="content">
            <div class="title">Chi tiết tài liệu</div>

            <div class="container">
                <form class="form" id="form">
                    <div>
                        <label class="label">ID</label>
                        <input type="text" id="docid" class="articleid" disabled>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="doctype" class="articletype" disabled>
                    </div>
                    <div>
                        <label class="label">Image</label>
                        <input type="text" id="doccover" class="articlecover" disabled>
                    </div>
                    <div>
                    ...
                    <div class="button">
                        <button id="cancel" class="btn cancel" onclick="document.location='indexphp?thuvien'" type="button">Back</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="assets/js/admin/lib-detail.js"></script>
</body>
</html>