...
<body>
    ...
    <section id="content">
        ...
        <div class="content">
            <div class="title">Chi tiết bảng tin</div>

            <div class="container">
                <form class="form" id="form">
                    <div>
                        <label class="label">ID</label>
                        <input type="text" id="newsid" class="articleid" disabled>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="newscover" class="articlecover" disabled>
                    </div>
    ...
    <script src="assets/js/admin/newsfeed-detail.js"></script>
</body>
</html>